...
/* 32-bit addressing is supported only by ESP32S3, ESP32P4 || ESP32P4RC1 and ESP32C5 */
...
typedef enum {
  ...
  /* Deprecated - Flash encryption is now supported by flash (deflated) begin command */
