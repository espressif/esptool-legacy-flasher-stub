...
#define USB_DEVICE_WR_DONE                (MEM32(USB_DEVICE_EP1_CONF_REG) & USB_DEVICE_WR_DONE_MASK)
#define USB_DEVICE_SERIAL_IN_EP_DATA_FREE (MEM32(USB_DEVICE_EP1_CONF_REG) & USB_DEVICE_SERIAL_IN_EP_DATA_FREE_MASK)
#define USB_DEVICE_EP1                    (MEM32(USB_DEVICE_EP1_REG))
#define USB_DEVICE_EP1_CONF               (MEM32(USB_DEVICE_EP1_CONF_REG))
