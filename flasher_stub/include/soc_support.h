...
#if defined(ESP32P4) || defined(ESP32P4RC1)
#define WITH_USB_JTAG_SERIAL 1
#define WITH_USB_OTG 1
#define IS_RISCV 1
...
#define USB_DEVICE_WR_DONE_MASK                0x01u
#define USB_DEVICE_SERIAL_IN_EP_DATA_FREE_MASK 0x02u

#define USB_DEVICE_WR_DONE                (READ_REG(USB_DEVICE_EP1_CONF_REG) & USB_DEVICE_WR_DONE_MASK)
#define USB_DEVICE_SERIAL_IN_EP_DATA_FREE (READ_REG(USB_DEVICE_EP1_CONF_REG) & USB_DEVICE_SERIAL_IN_EP_DATA_FREE_MASK)
#define USB_DEVICE_EP1                    (READ_REG(USB_DEVICE_EP1_REG))
#define USB_DEVICE_EP1_CONF               (READ_REG(USB_DEVICE_EP1_CONF_REG))
...
#if ESP32C61 || ESP32C6 || ESP32C5 || ESP32C5BETA3 || ESP32P4 || ESP32P4RC1
...
#if ESP32C3 || ESP32C6BETA || ESP32C2 || ESP32C6 || ESP32C61 || ESP32C5BETA3
#define ROM_SPIFLASH_LEGACY         0x3fcdfff4
#endif // ESP32C3 || ESP32C6BETA || ESP32C2 || ESP32C6 || ESP32C61 || ESP32C5BETA3
...
#if ESP32C5
#define ROM_SPIFLASH_LEGACY         0x4085fff0
#endif // ESP32C5
...
#endif // ESP32P4 || ESP32P4RC1 || ESP32C5
